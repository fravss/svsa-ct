...
@NamedQueries({
	...
	@NamedQuery(name="AgendamentoFamiliar.buscarAtendAgendados", query="select la from AgendamentoFamiliar la "
			+ "where la.statusAtendimento = :status "
			+ "and la.unidade = :unidade "
...
public class AgendamentoFamiliar implements Serializable {
    ...
    @JoinTable(name="ConselheiroAtendFamiliar", joinColumns={@JoinColumn(name="codigo_atendimento")}, 
