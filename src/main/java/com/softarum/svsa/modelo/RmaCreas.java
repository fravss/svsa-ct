...
public class RmaCreas implements Serializable {
	...
	private Integer bloco4k1 = 0;
	private Integer bloco4k2 = 0;
	private Integer bloco4k3 = 0;
	private Integer bloco4k4 = 0;
	private Integer bloco4k5 = 0;
	private Integer bloco4k6 = 0;
	private Integer bloco4k7 = 0;
	
	private Integer bloco4l1 = 0;
	...
	//k1
	@OneToOne(cascade=CascadeType.ALL)
	@JoinColumn(name="codigo_k1masc")
	private Vitima k1vitimaMasc;
	@OneToOne(cascade=CascadeType.ALL)
	@JoinColumn(name="codigo_k1fem")
	private Vitima k1vitimaFem;
