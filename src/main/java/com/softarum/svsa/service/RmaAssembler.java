...
public class RmaAssembler {
	...
	private RmaCreas modelMapper(RmaCreasTO to){
		...
		// bloco4
		rma.setBloco4k1(to.getBloco4().getE1());
		rma.setBloco4k2(to.getBloco4().getE2());
		rma.setBloco4k3(to.getBloco4().getE3());
		rma.setBloco4k4(to.getBloco4().getE4());
		rma.setBloco4k5(to.getBloco4().getE5());
		rma.setBloco4k6(to.getBloco4().getE6());
		rma.setBloco4k7(to.getBloco4().getE7());
		rma.setBloco4l1(to.getBloco4().getF1());
		...
		//bloco4			
		rma.setK1vitimaFem(modelMapper(to.getBloco4().getE1vitimasFem()));
		rma.setK1vitimaMasc(modelMapper(to.getBloco4().getE1vitimasMasc()));
	...
	private RmaCreasTO modelMapper(RmaCreas rma){
		...
		// bloco4
		to.getBloco4().setE1(rma.getBloco4k1());
		to.getBloco4().setE2(rma.getBloco4k2());
		to.getBloco4().setE3(rma.getBloco4k3());
		to.getBloco4().setE4(rma.getBloco4k4());
		to.getBloco4().setE5(rma.getBloco4k5());
		to.getBloco4().setE6(rma.getBloco4k6());
		to.getBloco4().setE7(rma.getBloco4k6());
		to.getBloco4().setF1(rma.getBloco4l1());
		...
		//bloco4			
		to.getBloco4().setE1vitimasFem(modelMapper(rma.getK1vitimaFem()));
		to.getBloco4().setE1vitimasMasc(modelMapper(rma.getK1vitimaMasc()));
